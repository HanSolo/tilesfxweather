...
public class WeatherTileSkin extends TileSkin {
    ...
    public void setDataPoint(final DataPoint dataPoint, final Unit unit) {
    ...
    @Override protected void redraw() {
        ...
        if (tile.getCustomDecimalFormatEnabled()) {
            valueText.setText(decimalFormat.format(dataPoint.getTemperature()));
        } else {
            valueText.setText(String.format(locale, formatString, dataPoint.getTemperature()));
        }
        unitText.setText(unit.temperatureUnitString);
        weatherSymbol.setCondition(dataPoint.getCondition());
        text.setText(normalize(dataPoint.getSummary()));
        sunriseText.setText(TF.format(dataPoint.getSunriseTime()));
        sunsetText.setText(TF.format(dataPoint.getSunsetTime()));
        resizeDynamicText();
